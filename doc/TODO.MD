...
- [ ] mouse input support                                 (2)
      - [ ] getting mouse position
      - [ ] getting mouse motion since.. ???
      - [ ] setting mouse visbility
      - [ ] setting mouse position
      - [ ] setting mouse locking
      - [ ] getting mouse down, pressed, released
      - [ ] raw motion?
      - [ ] getting cursor in window
