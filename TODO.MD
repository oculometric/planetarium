...
- [ ] handle image management in its own file
...
- [ ] fix swapchain resize being called constantly after resize
...
- [ ] fix invalid free pointer on exit via window close button
